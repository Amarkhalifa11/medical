...
@section('content')
    <h1 style="margin-left: 500px" class="mt-5">Add Doctor</h1>
    ...
    <div class="col-lg-12 mt-5 " style="margin-bottom: 200px">
        ...
        <div class="card">
          <div class="card-body">
                    ...
                    <!-- Vertical Form -->
                    <form class="row g-3 mt-5" action="{{ route('backend.admins.doctors.store') }}" enctype="multipart/form-data" method="POST">
                        @csrf
                      ...
                      <div class="col-12">
                        ...
                        <input type="tect" name="name"   class="form-control" id="inputNanme4">
                      </div>
                      @error('name')
                      ...
                      <div class="col-12">
                        ...
                        <textarea name="desc"   class="form-control" id="inputNanme4"></textarea>
                      </div>
                      @error('desc')
                      <div class="alert alert-danger">{{ $message }}</div>
                      @enderror
                      ...
                      <div class="col-12">
                        ...
                        <input type="tect" name="twitter"   class="form-control" id="inputNanme4">
                      </div>
                      @error('twitter')
                      <div class="alert alert-danger">{{ $message }}</div>
                      @enderror
                      ...
                      <div class="col-12">
                        ...
                        <input type="tect" name="instagram"   class="form-control" id="inputNanme4">
                      </div>
                      @error('instagram')
                      <div class="alert alert-danger">{{ $message }}</div>
                      @enderror
                      ...
                      <div class="col-12">
                        ...
                        <input type="tect" name="linkiden"   class="form-control" id="inputNanme4">
                      </div>
                      @error('linkiden')
                      <div class="alert alert-danger">{{ $message }}</div>
                      @enderror
                      ...
                      <div class="col-12">
                        ...
                        <input type="tect" name="facebook"   class="form-control" id="inputNanme4">
                      </div>
                      @error('facebook')
                      <div class="alert alert-danger">{{ $message }}</div>
                      @enderror
