...
@section('content')
    <h1 style="margin-left: 500px" class="mt-5">Add service</h1>
    ...
    <div class="col-lg-12 mt-5 " style="margin-bottom: 200px">
        ...
        <div class="card">
          <div class="card-body">
                    ...
                    <!-- Vertical Form -->
                    <form class="row g-3 mt-5" action="{{ route('backend.admins.all_services.store') }}"  method="POST">
                        @csrf
                      ...
                      <div class="col-12">
                        ...
                        <input type="text" name="icon"  value=""  class="form-control" id="inputEmail4">
                      </div>
                      @error('icon')
                      <div class="alert alert-danger">{{ $message }}</div>
                      @enderror
                      ...
                      <div class="col-12">
                        ...
                        <textarea name="desc"  value=""  class="form-control" id="inputEmail4"></textarea>
                      </div>
                      @error('desc')
                      <div class="alert alert-danger">{{ $message }}</div>
                      @enderror
