...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="{{ asset('frowntend/docs/4.0/assets/img/favicons/favicon.ico') }}">
    ...
    <!-- Bootstrap core CSS -->
    <link href="{{ asset('frowntend/dist/css/bootstrap.min.css') }}" rel="stylesheet">

    <!-- Custom styles for this template -->
    <link href="{{ asset('frowntend/assets/signin.css') }}" rel="stylesheet">
  </head>

  <body class="text-center">
    <form class="form-signin">
        <h1 style="margin-top: 100px">Welcome To Medical Website</h1>
      <img class="mb-4 mt-5" src="{{ asset('frowntend/medical-scientist-ai.jpg') }}" width="500" height="200" alt="" width="72" height="72">
      <div class="checkbox mb-3">
<h1 class="mt-2">
    <a href="{{ route('home') }}"><button type="button" class="btn btn-primary btn-lg" >User</button></a>
    <a href="{{ route('admin.login') }}"><button type="button" class="btn btn-primary btn-lg">Admin</button></a>
